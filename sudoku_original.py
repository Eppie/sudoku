...
def getRegion(x):
    ...
    a = getAcross(x)
    d = getDown(x)
    if 1 <= a and a < 4 and 1 <= d and d < 4:
        i = 1
    elif 4 <= a and a < 7 and 1 <= d and d < 4:
        i = 2
    elif 7 <= a and a < 10 and 1 <= d and d < 4:
        i = 3
    elif 1 <= a and a < 4 and 4 <= d and d < 7:
        i = 4
    elif 4 <= a and a < 7 and 4 <= d and d < 7:
        i = 5
    elif 7 <= a and a < 10 and 4 <= d and d < 7:
        i = 6
    elif 1 <= a and a < 4 and 7 <= d and d < 10:
        i = 7
    elif 4 <= a and a < 7 and 7 <= d and d < 10:
        i = 8
    elif 7 <= a and a < 10 and 7 <= d and d < 10:
        i = 9
    return i
